Raphael.fn.clock = function (cx, cy, rad) {
  ...
  this.rollBack = function (years) {
    ...
    if(salary < 100000){
      ...
      thesalary.attr('text', "Dirhams."+formatDollar(salary));
    }
    ...
    chart.push( 
      ...
      workingFor = paper.text(cx, (cy+(rad-(fontSizer*9.8))), "Moroccan Government").attr({"font-family": "Poppins", 'font-size': (fontSizer+6)+"px", "font-style":"italic", fill:"#fff"}),
